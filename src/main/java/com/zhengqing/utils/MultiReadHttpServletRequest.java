...
/**
 * <p> Use HTTP REQUEST to read and write BODY multiple times - solve the problem that the stream can only be read once </p>
 *
 * @author : zhengqing
 * @description :
...
public class MultiReadHttpServletRequest extends HttpServletRequestWrapper {
    ...
    /**
     * Convert the form data requested by the front-end into a json string - used when the front-end and back-end are integrated
     * @param request:
...
//        SecurityUser user = JSONObject.parseObject(JSONObject.toJSONString(bodyMap), SecurityUser.class);
    ...
    /**
     * Convert the json data passed by the front end into a json string - used when the front and back ends are separated
     * @param request:
     * @return: java.lang.String
     */
